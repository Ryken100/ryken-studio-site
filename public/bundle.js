...
module.exports = "<div> <img data-u=image class=logo src=./assets/img/myTube.png /> <div data-u=thumb>Slide Description 001</div> </div> <div> <img data-u=image class=logo src=\"assets/img/Photo Shader/screen1.png\"/> <div data-u=thumb>Slide Description 002</div> </div> <div> <img data-u=image class=logo src=\"assets/img/Photo Shader/screen2.png\"/> <div data-u=thumb>Slide Description 003</div> </div> <div> <img data-u=image class=logo src=\"assets/img/Photo Shader/screen3.png\"/> <div data-u=thumb>Slide Description 004</div> </div> <div> <img data-u=image class=logo src=\"assets/img/Photo Shader/screen4.png\"/> <div data-u=thumb>Slide Description 004</div> </div> <div style=background-color:#ff7c28> <div style=position:absolute;top:50px;left:50px;width:450px;height:62px;z-index:0;font-size:16px;color:#000;line-height:24px;text-align:left;padding:5px;box-sizing:border-box>Photos in this slider are to demostrate jssor slider, <br/> which are not licensed for any other purpose. </div> <div data-u=thumb>Terms of use photos in this slider</div> </div> ";
...
_assets_js_zenscroll_min_js__WEBPACK_IMPORTED_MODULE_1___default.a.setup(null, 0); // Setup zenscroll to support URL hashes
    ...
    for (let i in document.getElementsByClassName('navButton')) { // Loop through all the navButtons
        if (document.getElementsByClassName('navButton')[i].classList && document.getElementsByClassName('navButton')[i].classList[0] == 'navButton') { // Make sure it has a proper classList
            ...
            document.getElementsByClassName('navButton')[i].addEventListener('click', () => { // Add a 'click' event listenter 
                _assets_js_zenscroll_min_js__WEBPACK_IMPORTED_MODULE_1___default.a.intoView(section, 500, () => { // Scroll that section into view over 500ms
